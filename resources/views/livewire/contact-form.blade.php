                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative shadow-sm">
                            <input wire:model="name" id="name" name="name" value="{{ old('name') }}"
                                   class="border rounded-md @error('name') border-red-500 @enderror form-input block w-full py-3 px-4 placeholder-gray-500 transition ease-in-out duration-150"
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative shadow-sm">
                            <input wire:model="email" id="email" type="text" name="email"
                                   value="{{ old('email') }}"
                                   class="border rounded-md @error('email') border-red-500 @enderror form-input block w-full py-3 px-4 placeholder-gray-500 transition ease-in-out duration-150"
                                   placeholder="Email">
                        </div>
                        @error('email')
                        <p class="text-red-500 mt-1 text-xs">{{ $message }}</p>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative shadow-sm">
                            <input wire:model="phone" id="phone" name="phone" value="{{ old('phone') }}"
                                   class="border rounded-md @error('phone') border-red-500 @enderror form-input block w-full py-3 px-4 placeholder-gray-500 transition ease-in-out duration-150"
                                   placeholder="Phone">
                        </div>
                        @error('phone')
                        <p class="text-red-500 mt-1 text-xs">{{ $message }}</p>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative shadow-sm">
                            <textarea wire:model="message" id="message" rows="4" name="message"
                                      class="border rounded-md @error('message') border-red-500 @enderror form-input block w-full py-3 px-4 placeholder-gray-500 transition ease-in-out duration-150"
